...
const LAB10_STEPS = [
  {
    ...
    simHtml: `
      <div class="fake-app">
        <div class="fake-topbar">POST /api/orders/lookup</div>
        <div class="fake-body">
  ...
  },
  {
    ...
    simHtml: `
      <div class="fake-app">
        <div class="fake-topbar">GET /api/permissions/check</div>
        <div class="fake-body">
  ...
  },
  {
    ...
    simHtml: `
      <div class="fake-app">
        <div class="fake-topbar">GET /admin/reports (as guest)</div>
        <div class="fake-body">
